...
- All audit findings from 2026-06-08 have been fully resolved and covered by tests:
  ...
  - [x] **Ticket relational integrity**: Fixed by validating that `branch_id`, `department_id`, and `category_id` references are active (`status => active`). Note: `queue_id` was deprecated and removed entirely in Phase 5 of the Helpdesk Flow Refactor.
