...
- Keep Laravel structure conventional: controllers in `app/Http/Controllers`, requests in `app/Http/Requests`, concerns in `app/Concerns`, and established route split under `routes/`.
