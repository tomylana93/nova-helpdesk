...
import { store } from '@/actions/App/Http/Controllers/Admin/MasterData/QueueController';
...
import { create, index } from '@/routes/admin/master-data/queues';
...
setLayoutProps({
    breadcrumbs: [
        ...
        {
            title: trans('admin.master_data.queue.create.title'),
            href: create(),
        },
    ],
});
...
<template>
    <Head :title="trans('admin.master_data.queue.create.title')" />

    <PageWrapper
        :title="trans('admin.master_data.queue.create.heading')"
        :description="trans('admin.master_data.queue.create.description')"
    >
        <form class="flex flex-col gap-6" @submit.prevent="submit">
            ...
            >
                ...
                >
                    ...
                    {{ trans('admin.master_data.queue.action.create') }}
                </Button>
                <Button
                    type="button"
                    variant="secondary"
