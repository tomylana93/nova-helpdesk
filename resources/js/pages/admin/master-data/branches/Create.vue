...
import { store } from '@/actions/App/Http/Controllers/Admin/MasterData/BranchController';
...
import { create, index } from '@/routes/admin/master-data/branches';
...
setLayoutProps({
    breadcrumbs: [
        ...
        {
            title: trans('admin.master_data.branch.create.title'),
            href: create(),
        },
    ],
});
...
<template>
    <Head :title="trans('admin.master_data.branch.create.title')" />

    <PageWrapper
        :title="trans('admin.master_data.branch.create.heading')"
        :description="trans('admin.master_data.branch.create.description')"
    >
        <form class="flex flex-col gap-6" @submit.prevent="submit">
            ...
            >
                ...
                >
                    ...
                    {{ trans('admin.master_data.branch.action.create') }}
                </Button>
                <Button
                    type="button"
                    variant="secondary"
