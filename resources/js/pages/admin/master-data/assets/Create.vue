...
import { store } from '@/actions/App/Http/Controllers/Admin/MasterData/AssetController';
...
import { create, index } from '@/routes/admin/master-data/assets';
...
function submit(): void {
    ...
    form.transform(() => payload).submit(store());
}
...
setLayoutProps({
    breadcrumbs: [
        ...
        {
            title: trans('admin.master_data.asset.create.title'),
            href: create(),
        },
    ],
});
...
<template>
    <Head :title="trans('admin.master_data.asset.create.title')" />

    <PageWrapper
        :title="trans('admin.master_data.asset.create.heading')"
        :description="trans('admin.master_data.asset.create.description')"
    >
        <form class="flex max-w-2xl flex-col gap-6" @submit.prevent="submit">
            ...
            >
                ...
                >
                    ...
                    {{ trans('admin.master_data.asset.action.create') }}
                </Button>
                <Button
                    type="button"
                    variant="secondary"
