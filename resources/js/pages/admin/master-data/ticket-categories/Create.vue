...
import { store } from '@/actions/App/Http/Controllers/Admin/MasterData/TicketCategoryController';
...
import { create, index } from '@/routes/admin/master-data/ticket-categories';
...
setLayoutProps({
    breadcrumbs: [
        ...
        {
            title: trans('admin.master_data.ticket_category.create.title'),
            href: create(),
        },
    ],
});
...
<template>
    <Head :title="trans('admin.master_data.ticket_category.create.title')" />

    <PageWrapper
        :title="trans('admin.master_data.ticket_category.create.heading')"
        :description="
            trans('admin.master_data.ticket_category.create.description')
        "
    >
        <form class="flex flex-col gap-6" @submit.prevent="submit">
            ...
            >
                ...
                >
                    ...
                    {{
                        trans('admin.master_data.ticket_category.action.create')
                    }}
                </Button>
                <Button
                    type="button"
