...
import {
    ...
    index,
    show,
} from '@/routes/admin/master-data/ticket-categories';
...
setLayoutProps({
    breadcrumbs: [
        ...
        {
            title: trans('admin.master_data.ticket_category.show.title'),
...
<template>
    <Head :title="trans('admin.master_data.ticket_category.show.title')" />

    <PageWrapper
        :title="trans('admin.master_data.ticket_category.show.heading')"
        :description="
            trans('admin.master_data.ticket_category.show.description')
        "
    >
        <template #actions>
            <Button
                v-if="page.props.auth.abilities.manage_categories"
                :as="Link"
