...
import { update } from '@/actions/App/Http/Controllers/Admin/MasterData/DepartmentController';
...
import { edit, index } from '@/routes/admin/master-data/departments';
...
function submit(): void {
    form.submit(update(props.department.id));
}
...
setLayoutProps({
    breadcrumbs: [
        ...
        {
            title: trans('admin.master_data.department.edit.title'),
...
<template>
    <Head :title="trans('admin.master_data.department.edit.title')" />

    <PageWrapper
        :title="trans('admin.master_data.department.edit.heading')"
        :description="trans('admin.master_data.department.edit.description')"
    >
        <form class="flex flex-col gap-6" @submit.prevent="submit">
            ...
            >
                ...
                >
                    ...
                    {{ trans('admin.master_data.department.action.update') }}
                </Button>
                <Button
                    type="button"
                    variant="secondary"
